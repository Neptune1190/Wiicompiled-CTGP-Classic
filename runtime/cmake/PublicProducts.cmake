...
if(MKW_HAVE_RETRO_REWIND)
    ...
    if(MKW_MOD_OUTPUT_NAME STREQUAL "CTGPClassic")
        target_compile_definitions(RetroRewind PRIVATE MKW_CTGP_CLASSIC_PRODUCT)
    endif()
    set_target_properties(RetroRewind PROPERTIES OUTPUT_NAME "${MKW_MOD_OUTPUT_NAME}")
